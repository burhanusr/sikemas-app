    ...
    <div class="space-y-6">
        ...
        <div class="rounded-xl border border-green-100 bg-white p-6 shadow-sm">
            <div class="mb-6 flex flex-col justify-between gap-4 md:flex-row md:items-center">
                <h3 class="text-lg font-semibold text-gray-800">Grafik Pemasukan & Pengeluaran Tahun {{ $selectedYear }}
                </h3>
                <div class="flex flex-wrap items-center gap-3">
                    <label for="yearSelect" class="text-sm font-medium text-gray-600">Pilih Tahun:</label>
                    <select id="yearSelect" onchange="updateChart()"
                        class="rounded-lg border border-gray-300 px-4 py-2 text-sm focus:border-green-500 focus:outline-none focus:ring-2 focus:ring-green-500/20">
